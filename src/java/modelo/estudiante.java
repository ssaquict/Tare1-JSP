...
public class estudiante extends persona{
    ...
    try{
        cn = new conexion();
        cn.abrir_conexion();
            String query = "SELECT e.id_estudiante as id,e.carne,e.nombres,e.apellidos,e.direccion,e.telefono,e.correo_electronico,e.fecha_nacimiento,p.sangre,e.id_tipo_sangre FROM estudiantes as e inner join tipos_sangre as p on e.id_tipo_sangre = p.id_tipo_sangre;";
            //String query = "SELECT id_estudiante as id,carne,nombres,apellidos,direccion,telefono,correo_electronico,fecha_nacimiento,id_tipo_sangre FROM  estudiantes;";
            ResultSet consulta = cn.conexionBD.createStatement().executeQuery(query);
            String encabezado[] = {"id","Carne","Nombres","Apellidos","Direccion","Telefono","Email","Fecha Nacimiento","Id Tipo"};
